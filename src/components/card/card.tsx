...
const Card: React.FC<CardProps> = ({ title, image, description }) => {
  return (
    <div className="w-64 h-96 p-6 flex flex-col shadow-card3 hover:shadow-card4 dark:hover:shadow-none transition rounded-md overflow-hidden bg-grey dark:bg-lprimary cursor-pointer hover:-translate-y-1">
